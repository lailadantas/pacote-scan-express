...
const PacotesProblema = () => {
  ...
  const pacotes = [
    { id: 6, codigo: 'PKG006', status: 'Problema', dataRecebimento: '2024-01-14' },
    { id: 7, codigo: 'PKG007', status: 'Problema', dataRecebimento: '2024-01-15' },
    { id: 8, codigo: 'PKG008', status: 'Problema', dataRecebimento: '2024-01-16' }
  ];
  ...
  return (
    <MobileLayout title="Pacotes com problema" showBackButton>
...
export default PacotesProblema;
